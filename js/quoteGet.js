var quotes = [
    ...
    "\"No single thing abides; and all things are fucked up.\"    --Philip K. Dick (The Transmigration of Timothy Archer)",
    ...
    "\"You see, gentlemen, they have something to die for. They\'ve discovered they\'re a people. They\'re awakening.\"    --Frank Herbert (Dune)",
...
function newQuote() {
    ...
    document.getElementById('myQuoteDisplay').innerHTML = quotes[randomNumber];
}
